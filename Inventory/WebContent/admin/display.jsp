            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fa fa-table"></i> Supplier's List </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${supplierList}" var="supplier" >
                                        <tr>
                                            ...
                                            <td><a  class="btn btn-secondary btn-block" href="${cp}/Admin/Supplier?action=edit&id=${supplier.id}">EDIT</a></td>
                                            <td><a class="btn  btn-warning btn-block" href="${pageContext.request.contextPath}/Admin/Supplier?action=delete&id=${supplier.id}">DELETE</a></td>
