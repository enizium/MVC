<%-- 
    ...
    Created on : Jun 12, 2018, 10:57:57 AM
    Author     : enizium
--%>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Product-Supplier Relation</li>
                </ol>
                <!--add supplier form-->


                <div class="card card-register mx-auto mt-5">
                    <div class="card-header">Add Relation</div>
                    <div class="card-body">

                        <form  method="post" action="${pageContext.request.contextPath}/Admin/Relation?action=add">
                            ...
                            <button type="submit" class="btn btn-primary btn-block" >Add Relationship</button>
                        </form>
