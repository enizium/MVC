...
<!-- Custom CSS -->
<link
	href="${pageContext.request.contextPath}/css/thumbnail-gallery.css"
	rel="stylesheet">
</head>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
						...
						<div class="col-lg-3 col-md-4 col-xs-6 thumb">
							...
							<div>
								<ul type="none">
									...
									<li><a
										href="${pageContext.request.contextPath}/Admin/Product?action=edit&id=${product.id}">Edit</a>
									<li><a
										href="${pageContext.request.contextPath}/Admin/Product?action=delete&id=${product.id}">Delete</a>
								</ul>
							</div>
						</div>
					</c:forEach>
		...
		<script
			src="${pageContext.request.contextPath}/vender/jquery/jquery.js"></script>
		<script
			src="${pageContext.request.contextPath}/vender/bootstarp/js/bootstrap.min.js"></script>
	</div>
</body>
