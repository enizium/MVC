		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Sales Statement
				</div>
				<div class="card-body">
								...
								<c:forEach items="${sales}" var="sales">
									<tr>
										...
										<td><a class="btn btn-secondary btn-block"
											href="${cp}/Admin/Sale?action=edit&id=${sales.id}">EDIT</a></td>
										<td><a class="btn  btn-warning btn-block"
											href="${pageContext.request.contextPath}/Admin/Sale?action=delete&id=${sales.id}">DELETE</a></td>
