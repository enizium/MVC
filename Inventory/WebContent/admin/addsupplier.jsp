		...
		<div class="container-fluid">
			...
			<div class="card card-register mx-auto mt-5">
				...
				<div class="card-body">
					...
					<form method="post"
						action="${pageContext.request.contextPath}/Admin/Supplier?action=add">
							...
							<div class="form-row">
								...
								<div class="col-md-6">
									<label for="city">City </label> <input class="form-control"
										id="city" name="city" type="text" placeholder=" city" required>
								</div>
							...
							<div class="form-row">
								<div class="col-md-6">
									<label for="street">Street/House</label> <input
										class="form-control" id="street" name="street" type="text"
							...
							<div class="form-row">
								...
								<div class="col-md-4">
									<label for="acc_bank">Bank Name</label> <input
										class="form-control" id="acc_bank" name="acc_bank" type="text"
										placeholder="Enter Bank Number ">
								</div>
								<div class="col-md-4">
									<label for="acc_no">Account Number</label> <input
										class="form-control" id="acc_no" name="acc_no" type="text"
