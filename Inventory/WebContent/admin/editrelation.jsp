...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			<!-- Breadcrumbs-->
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Relationship</a></li>
				<li class="breadcrumb-item active">Edit Product-Supplier
					Relation</li>
			</ol>
			<!--add supplier form-->
			...
			<div class="card card-register mx-auto mt-5">
				...
				<div class="card-body">
					...
					<form method="post"
						action="${pageContext.request.contextPath}/Admin/Relation?action=update">
						<div class="form-group">
							<div class="form-row">
								<div class="col-md-3">
									<label for="id">Product-Supplier Id</label> <input
										class="form-control" type="text" name="id" id="id"
										value="${productsupplier.id}" readonly>
								</div>
							</div>
							<div class="form-row">
								<div class="col-md-6">
									<label for="product">Product</label> <select
										...
										<c:forEach items="${productdata}" var="prod">
											<option value="${prod.id}"
												<c:if test="${prod.id.equals('${sppid}')}"> 
									...
									<label for="supplier">Supplier</label> <select
										...
										<c:forEach items="${supplierdata}" var="supp">
											<option value="${supp.id}"
												<c:if test="${supp.id.equals('${productsupplier.sid}')}"> 
