		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Stock of Product
				</div>
				<div class="card-body">
								...
								<c:forEach items="${stock}" var="stock">
									<tr>
										...
										<td><a class="btn btn-secondary btn-block"
											href="${cp}/Admin/Supplier?action=edit&id=${stock.id}">EDIT</a></td>
										<td><a class="btn  btn-warning btn-block"
											href="${pageContext.request.contextPath}/Admin/Supplier?action=delete&id=${stock.id}">DELETE</a></td>
