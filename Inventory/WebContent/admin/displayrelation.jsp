...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			<!-- Breadcrumbs-->
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Relatioship</a></li>
				<li class="breadcrumb-item active">Display Product-Supplier
					Relationship</li>
			</ol>
								...
								<c:forEach items="${productsupplierdata}" var="ps">
									<tr>
										...
										<td><a class="btn btn-secondary btn-block"
											href="${pageContext.request.contextPath}/Admin/Relation?action=edit&id=${ps.id}">EDIT</a></td>
										<td><a class="btn  btn-warning btn-block"
											href="${pageContext.request.contextPath}/Admin/Relation?action=delete&id=${ps.id}">DELETE</a></td>
