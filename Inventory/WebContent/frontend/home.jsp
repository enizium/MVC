...
<html>
    ...
    <body>
        ...
        <div class="navbar">
            ...
            <a href="${pageContext.request.contextPath}/Book?action=display">List of Books</a>
            <a href="${pageContext.request.contextPath}/Book?action=add">Add Book</a>
            <a href="${pageContext.request.contextPath}/Admin?action=home">Admin Dashboard</a>
